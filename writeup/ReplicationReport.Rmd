...
However, we have reduced the amount of data collected per subject from 5 blocks to 2, as noted in the Procedure section. Thus we increased our sample size to 30 participants, in order to collect the same total amount of data.
...
3. The original study did not state how out of range capacity estimates, we chose to allow these to avoid breaking the statistical assumptions of the hypothesis tests.
...
###Accuracy-based secondary Analysis
```{r}
